...
- `F.18` --builds_on--> [Contextual Lexicon Principles](/generated/patterns/F.0.1)
- `F.18` --builds_on--> [Domain‑Family Landscape Survey](/generated/patterns/F.1)
- `F.18` --builds_on--> [Intra‑Context Sense Clustering](/generated/patterns/F.3)
- `F.18` --builds_on--> [Naming Discipline for U.Types & Roles](/generated/patterns/F.5)
- `F.18` --builds_on--> [Concept‑Set Table Construction](/generated/patterns/F.7)
- `F.18` --builds_on--> [Mint or Reuse? (U.Type vs Concept-Set vs Role Description vs Alias)](/generated/patterns/F.8)
- `F.18` --builds_on--> [Lexical Continuity & Deprecation](/generated/patterns/F.13)
- `F.18` --builds_on--> [Anti‑Explosion Control (Roles & Statuses)](/generated/patterns/F.14)
- `F.18` --builds_on--> [SCR/RSCR Harness for Unification](/generated/patterns/F.15)
- `F.18` --builds_on--> [Unified Term Sheet (UTS)](/generated/patterns/F.17)
- `F.18` --constrains--> [A.CHR-NORM — Canonical “Characteristic” & rename (Dimension/Axis → Characteristic)](/generated/patterns/A.17)
- `F.18` --constrains--> [A.CSLC-KERNEL — Minimal CSLC in Kernel (Characteristic/Scale/Level/Coordinate)](/generated/patterns/A.18)
- `F.18` --explicit_reference--> [Domain‑Family Landscape Survey](/generated/patterns/F.1)
- `F.18` --explicit_reference--> [Unified Term Sheet (UTS)](/generated/patterns/F.17)
- `F.18` --explicit_reference--> [Evidence Graph & Provenance Ledger](/generated/patterns/G.6)
- `F.18` --explicit_reference--> [SoTA Pack Shipping (pack-boundary owner; SoTA-Pack(Core))](/generated/patterns/G.10)
- `F.18` --explicit_reference--> [Term Harvesting & Normalisation](/generated/patterns/F.2)
- `F.18` --explicit_reference--> [Intra‑Context Sense Clustering](/generated/patterns/F.3)
- `F.18` --explicit_reference--> [Language-State Transduction Coordination](/generated/patterns/A.16)
- `F.18` --explicit_reference--> [Bridge Stance Overlay](/generated/patterns/F.9.1)
- `F.18` --explicit_reference--> [Naming Discipline for U.Types & Roles](/generated/patterns/F.5)
- `F.18` --explicit_reference--> [Method Quartet Harmonisation](/generated/patterns/F.11)
- `F.18` --explicit_reference--> [Service Acceptance Binding](/generated/patterns/F.12)
- `F.18` --explicit_reference--> [Onboarding Glossary (NQD & E/E‑LOG)](/generated/patterns/A.0)
- `F.18` --explicit_reference--> [Creativity‑CHR — Characterising Generative Novelty & Value](/generated/patterns/C.17)
- `F.18` --explicit_reference--> [NQD‑CAL — Open‑Ended Search Calculus](/generated/patterns/C.18)
- `F.18` --explicit_reference--> [Creative Abduction with NQD](/generated/patterns/B.5.2.1)
- `F.18` --explicit_reference--> [Human-Centric Working-Model](/generated/patterns/E.14)
- `F.18` --explicit_reference--> [LEX-BUNDLE: Unified Lexical Rules for FPF](/generated/patterns/E.10)
- `F.18` --explicit_reference--> [Concept‑Set Table Construction](/generated/patterns/F.7)
- `F.18` --explicit_reference--> [MM-CHR — Measurement & Metrics Characterization](/generated/patterns/C.16)
- `F.18` --explicit_reference--> [Worked‑Example Template (Cross‑Domain)](/generated/patterns/F.16)
- `F.18` --explicit_reference--> [Lexical Continuity & Deprecation](/generated/patterns/F.13)
- `F.18` --explicit_reference--> [U.SpeechAct: Communicative Work Object](/generated/patterns/A.2.9)
- `F.18` --explicit_reference--> [U.Commitment: Deontic Commitment Object](/generated/patterns/A.2.8)
- `F.18` --explicit_reference--> [Alignment & Bridge across Contexts](/generated/patterns/F.9)
- `F.18` --explicit_reference--> [Contextual Lexicon Principles](/generated/patterns/F.0.1)
- `F.18` --explicit_reference--> [Status Families Mapping (Evidence • Standard • Requirement)](/generated/patterns/F.10)
- `F.18` --explicit_reference--> [Anti‑Explosion Control (Roles & Statuses)](/generated/patterns/F.14)
- `F.18` --explicit_reference--> [FPF Authoring Conventions & Style Guide](/generated/patterns/E.8)
- `F.18` --explicit_reference--> [A.CHR-NORM — Canonical “Characteristic” & rename (Dimension/Axis → Characteristic)](/generated/patterns/A.17)
- `F.18` --explicit_reference--> [A.CSLC-KERNEL — Minimal CSLC in Kernel (Characteristic/Scale/Level/Coordinate)](/generated/patterns/A.18)
