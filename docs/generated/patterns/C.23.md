...
- `C.23` --builds_on--> [Multi‑Method Dispatcher & MethodFamily Registry](/generated/patterns/G.5)
- `C.23` --builds_on--> [CAL Authoring: Calculi - Acceptance - Evidence](/generated/patterns/G.4)
- `C.23` --builds_on--> [Problem Typing & TaskSignature Assignment (Problem‑CHR)](/generated/patterns/C.22)
- `C.23` --builds_on--> [NQD‑CAL — Open‑Ended Search Calculus](/generated/patterns/C.18)
- `C.23` --builds_on--> [Explore–Exploit Governor (E/E‑LOG)](/generated/patterns/C.19)
- `C.23` --builds_on--> [Trust & Assurance Calculus (F–G–R with Congruence)](/generated/patterns/B.3)
- `C.23` --constrains--> [SoS-LOG Bundles & Maturity Ladders](/generated/patterns/G.8)
- `C.23` --constrains--> [Parity / Benchmark Harness](/generated/patterns/G.9)
- `C.23` --constrains--> [Telemetry-Driven Refresh & Decay Orchestrator](/generated/patterns/G.11)
- `C.23` --constrains--> [Multi‑Method Dispatcher & MethodFamily Registry](/generated/patterns/G.5)
- `C.23` --explicit_reference--> [Multi‑Method Dispatcher & MethodFamily Registry](/generated/patterns/G.5)
- `C.23` --explicit_reference--> [CAL Authoring: Calculi - Acceptance - Evidence](/generated/patterns/G.4)
- `C.23` --explicit_reference--> [Problem Typing & TaskSignature Assignment (Problem‑CHR)](/generated/patterns/C.22)
- `C.23` --explicit_reference--> [NQD‑CAL — Open‑Ended Search Calculus](/generated/patterns/C.18)
- `C.23` --explicit_reference--> [Explore–Exploit Governor (E/E‑LOG)](/generated/patterns/C.19)
- `C.23` --explicit_reference--> [Trust & Assurance Calculus (F–G–R with Congruence)](/generated/patterns/B.3)
- `C.23` --explicit_reference--> [Evidence Graph Referring (C-4)](/generated/patterns/A.10)
- `C.23` --explicit_reference--> [LEX-BUNDLE: Unified Lexical Rules for FPF](/generated/patterns/E.10)
- `C.23` --explicit_reference--> [Transduction Graph Architecture (E.TGA)](/generated/patterns/E.18)
- `C.23` --explicit_reference--> [Evidence Graph & Provenance Ledger](/generated/patterns/G.6)
- `C.23` --explicit_reference--> [SoS-LOG Bundles & Maturity Ladders](/generated/patterns/G.8)
- `C.23` --explicit_reference--> [Parity / Benchmark Harness](/generated/patterns/G.9)
- `C.23` --explicit_reference--> [Telemetry-Driven Refresh & Decay Orchestrator](/generated/patterns/G.11)
- `C.23` --explicit_reference--> [FPF Authoring Conventions & Style Guide](/generated/patterns/E.8)
- `C.23` --explicit_reference--> [Alignment & Bridge across Contexts](/generated/patterns/F.9)
- `C.23` --explicit_reference--> [GateProfilization: OperationalGate(profile) (GateFit core)](/generated/patterns/A.21)
