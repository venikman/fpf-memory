...
# Creativity‑CHR — Characterising Generative Novelty & Value
> Pattern `C.17` · Stable
...
- `C.17` --route_step--> [Explore–Exploit Governor (E/E‑LOG)](/generated/patterns/C.19)
- `C.17` --explicit_reference--> [Holonic Foundation: Entity → Holon](/generated/patterns/A.1)
- `C.17` --explicit_reference--> [Role–Method–Work Alignment (Contextual Enactment)](/generated/patterns/A.15)
- `C.17` --explicit_reference--> [CHR‑CAL – Characterisation Kit](/generated/patterns/C.7)
- `C.17` --explicit_reference--> [MM-CHR — Measurement & Metrics Characterization](/generated/patterns/C.16)
- `C.17` --explicit_reference--> [Creative Abduction with NQD](/generated/patterns/B.5.2.1)
- `C.17` --explicit_reference--> [Agency‑CHR](/generated/patterns/C.9)
- `C.17` --explicit_reference--> [Trust & Assurance Calculus (F–G–R with Congruence)](/generated/patterns/B.3)
- `C.17` --explicit_reference--> [Canonical Evolution Loop](/generated/patterns/B.4)
- `C.17` --explicit_reference--> [Role Assignment & Enactment Cycle (Six-Step)](/generated/patterns/F.6)
- `C.17` --explicit_reference--> [Naming Discipline for U.Types & Roles](/generated/patterns/F.5)
- `C.17` --explicit_reference--> [NQD‑CAL — Open‑Ended Search Calculus](/generated/patterns/C.18)
- `C.17` --explicit_reference--> [Explore–Exploit Governor (E/E‑LOG)](/generated/patterns/C.19)
- `C.17` --explicit_reference--> [Domain‑Family Landscape Survey](/generated/patterns/F.1)
- `C.17` --explicit_reference--> [Temporal Duality & Open-Ended Evolution Principle](/generated/patterns/A.4)
- `C.17` --explicit_reference--> [Unified Scope Mechanism (USM): Context Slices & Scopes](/generated/patterns/A.2.6)
- `C.17` --explicit_reference--> [Strict Distinction (Clarity Lattice)](/generated/patterns/A.7)
- `C.17` --explicit_reference--> [External Transformer & Reflexive Split (C-2)](/generated/patterns/A.12)
- `C.17` --explicit_reference--> [Local-First Unification Naming Protocol](/generated/patterns/F.18)
- `C.17` --explicit_reference--> [Role Taxonomy](/generated/patterns/A.2)
- `C.17` --explicit_reference--> [A.CHR-NORM — Canonical “Characteristic” & rename (Dimension/Axis → Characteristic)](/generated/patterns/A.17)
- `C.17` --explicit_reference--> [A.CSLC-KERNEL — Minimal CSLC in Kernel (Characteristic/Scale/Level/Coordinate)](/generated/patterns/A.18)
- `C.17` --explicit_reference--> [Universal Algebra of Aggregation (Γ)](/generated/patterns/B.1)
- `C.17` --explicit_reference--> [Evidence Graph Referring (C-4)](/generated/patterns/A.10)
- `C.17` --explicit_reference--> [A.CHR-SPACE — CharacteristicSpace & Dynamics hook](/generated/patterns/A.19)
- `C.17` --explicit_reference--> [KD‑CAL](/generated/patterns/C.2)
