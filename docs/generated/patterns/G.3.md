...
- `G.3` --builds_on--> [CG-Frame-Ready Generator](/generated/patterns/G.1)
- `G.3` --builds_on--> [SoTA Harvester & Synthesis](/generated/patterns/G.2)
- `G.3` --builds_on--> [Evidence Graph & Provenance Ledger](/generated/patterns/G.6)
- `G.3` --builds_on--> [CHRMechanismSuite — CHR mechanism-suite anchor (suite obligations + P2W planned baseline)](/generated/patterns/A.19.CHR)
- `G.3` --builds_on--> [SlotFillingsPlanItem — Planned Slot-Fillings Baseline (WorkPlanning PlanItem)](/generated/patterns/A.15.3)
- `G.3` --builds_on--> [A.CHR-NORM — Canonical “Characteristic” & rename (Dimension/Axis → Characteristic)](/generated/patterns/A.17)
- `G.3` --builds_on--> [A.CSLC-KERNEL — Minimal CSLC in Kernel (Characteristic/Scale/Level/Coordinate)](/generated/patterns/A.18)
- `G.3` --builds_on--> [MM-CHR — Measurement & Metrics Characterization](/generated/patterns/C.16)
- `G.3` --builds_on--> [Domain‑Family Landscape Survey](/generated/patterns/F.1)
- `G.3` --builds_on--> [Alignment & Bridge across Contexts](/generated/patterns/F.9)
- `G.3` --builds_on--> [Trust & Assurance Calculus (F–G–R with Congruence)](/generated/patterns/B.3)
- `G.3` --builds_on--> [Evidence Decay & Epistemic Debt](/generated/patterns/B.3.4)
- `G.3` --builds_on--> [Evidence Graph Referring (C-4)](/generated/patterns/A.10)
- `G.3` --builds_on--> [LEX-BUNDLE: Unified Lexical Rules for FPF](/generated/patterns/E.10)
- `G.3` --builds_on--> [DevOps Lexical Firewall](/generated/patterns/E.5.1)
- `G.3` --builds_on--> [Unidirectional Dependency](/generated/patterns/E.5.3)
- `G.3` --explicit_reference--> [CAL Authoring: Calculi - Acceptance - Evidence](/generated/patterns/G.4)
- `G.3` --explicit_reference--> [Multi‑Method Dispatcher & MethodFamily Registry](/generated/patterns/G.5)
- `G.3` --explicit_reference--> [CG-Frame-Ready Generator](/generated/patterns/G.1)
- `G.3` --explicit_reference--> [SoTA Harvester & Synthesis](/generated/patterns/G.2)
- `G.3` --explicit_reference--> [CHRMechanismSuite — CHR mechanism-suite anchor (suite obligations + P2W planned baseline)](/generated/patterns/A.19.CHR)
- `G.3` --explicit_reference--> [SlotFillingsPlanItem — Planned Slot-Fillings Baseline (WorkPlanning PlanItem)](/generated/patterns/A.15.3)
- `G.3` --explicit_reference--> [A.CSLC-KERNEL — Minimal CSLC in Kernel (Characteristic/Scale/Level/Coordinate)](/generated/patterns/A.18)
- `G.3` --explicit_reference--> [MM-CHR — Measurement & Metrics Characterization](/generated/patterns/C.16)
- `G.3` --explicit_reference--> [Domain‑Family Landscape Survey](/generated/patterns/F.1)
- `G.3` --explicit_reference--> [Alignment & Bridge across Contexts](/generated/patterns/F.9)
- `G.3` --explicit_reference--> [Trust & Assurance Calculus (F–G–R with Congruence)](/generated/patterns/B.3)
- `G.3` --explicit_reference--> [Evidence Decay & Epistemic Debt](/generated/patterns/B.3.4)
- `G.3` --explicit_reference--> [Evidence Graph Referring (C-4)](/generated/patterns/A.10)
- `G.3` --explicit_reference--> [Evidence Graph & Provenance Ledger](/generated/patterns/G.6)
- `G.3` --explicit_reference--> [NQD‑CAL — Open‑Ended Search Calculus](/generated/patterns/C.18)
- `G.3` --explicit_reference--> [Explore–Exploit Governor (E/E‑LOG)](/generated/patterns/C.19)
- `G.3` --explicit_reference--> [Telemetry-Driven Refresh & Decay Orchestrator](/generated/patterns/G.11)
- `G.3` --explicit_reference--> [Discipline‑CHR - Field Health & Structure](/generated/patterns/C.21)
- `G.3` --explicit_reference--> [CG-Spec — Frame Standard & Comparability Governance](/generated/patterns/G.0)
- `G.3` --explicit_reference--> [A.CHR-NORM — Canonical “Characteristic” & rename (Dimension/Axis → Characteristic)](/generated/patterns/A.17)
- `G.3` --explicit_reference--> [LEX-BUNDLE: Unified Lexical Rules for FPF](/generated/patterns/E.10)
- `G.3` --explicit_reference--> [DevOps Lexical Firewall](/generated/patterns/E.5.1)
- `G.3` --explicit_reference--> [Unidirectional Dependency](/generated/patterns/E.5.3)
