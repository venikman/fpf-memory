...
- `A.7` --builds_on--> [Holonic Foundation: Entity → Holon](/generated/patterns/A.1)
- `A.7` --builds_on--> [Role Taxonomy](/generated/patterns/A.2)
- `A.7` --builds_on--> [Transformer Constitution (Quartet)](/generated/patterns/A.3)
- `A.7` --builds_on--> [Evidence Graph Referring (C-4)](/generated/patterns/A.10)
- `A.7` --builds_on--> [External Transformer & Reflexive Split (C-2)](/generated/patterns/A.12)
- `A.7` --builds_on--> [Advanced Mereology: Components, Portions, Aspects & Phases](/generated/patterns/A.14)
- `A.7` --builds_on--> [Role–Method–Work Alignment (Contextual Enactment)](/generated/patterns/A.15)
- `A.7` --constrains--> [The Agential Role & Agency Spectrum](/generated/patterns/A.13)
- `A.7` --coordinates_with--> [Transduction Graph Architecture (E.TGA)](/generated/patterns/E.18)
- `A.7` --coordinates_with--> [GateProfilization: OperationalGate(profile) (GateFit core)](/generated/patterns/A.21)
- `A.7` --coordinates_with--> `A.27`
- `A.7` --coordinates_with--> [LEX-BUNDLE: Unified Lexical Rules for FPF](/generated/patterns/E.10)
- `A.7` --explicit_reference--> [External Transformer & Reflexive Split (C-2)](/generated/patterns/A.12)
- `A.7` --explicit_reference--> [The Agential Role & Agency Spectrum](/generated/patterns/A.13)
- `A.7` --explicit_reference--> [Advanced Mereology: Components, Portions, Aspects & Phases](/generated/patterns/A.14)
- `A.7` --explicit_reference--> [Role–Method–Work Alignment (Contextual Enactment)](/generated/patterns/A.15)
- `A.7` --explicit_reference--> [Transformer Constitution (Quartet)](/generated/patterns/A.3)
- `A.7` --explicit_reference--> [Concept‑Set Table Construction](/generated/patterns/F.7)
- `A.7` --explicit_reference--> [Mint or Reuse? (U.Type vs Concept-Set vs Role Description vs Alias)](/generated/patterns/F.8)
- `A.7` --explicit_reference--> [Alignment & Bridge across Contexts](/generated/patterns/F.9)
- `A.7` --explicit_reference--> [Role Taxonomy](/generated/patterns/A.2)
- `A.7` --explicit_reference--> [U.Method: The Abstract Way of Doing](/generated/patterns/A.3.1)
- `A.7` --explicit_reference--> [U.EffectFreeEpistemicMorphing — Effect-Free Morphisms of Epistemes](/generated/patterns/A.6.2)
- `A.7` --explicit_reference--> [U.EpistemicViewing — describedEntity-Preserving Morphism](/generated/patterns/A.6.3)
- `A.7` --explicit_reference--> [Holonic Foundation: Entity → Holon](/generated/patterns/A.1)
- `A.7` --explicit_reference--> [Evidence Graph Referring (C-4)](/generated/patterns/A.10)
- `A.7` --explicit_reference--> [FPF Authoring Conventions & Style Guide](/generated/patterns/E.8)
- `A.7` --explicit_reference--> [LEX-BUNDLE: Unified Lexical Rules for FPF](/generated/patterns/E.10)
- `A.7` --explicit_reference--> [Trust & Assurance Calculus (F–G–R with Congruence)](/generated/patterns/B.3)
- `A.7` --explicit_reference--> [Multi‑View Publication Kit (for Morphisms)](/generated/patterns/E.17)
- `A.7` --explicit_reference--> [Transduction Graph Architecture (E.TGA)](/generated/patterns/E.18)
- `A.7` --explicit_reference--> [GateProfilization: OperationalGate(profile) (GateFit core)](/generated/patterns/A.21)
