...
- `A.15.2` --route_step--> [SlotFillingsPlanItem — Planned Slot-Fillings Baseline (WorkPlanning PlanItem)](/generated/patterns/A.15.3)
- `A.15.2` --outline_parent--> [Role–Method–Work Alignment (Contextual Enactment)](/generated/patterns/A.15)
- `A.15.2` --outline_prev_sibling--> [U.Work: The Record of Occurrence](/generated/patterns/A.15.1)
- `A.15.2` --outline_next_sibling--> [SlotFillingsPlanItem — Planned Slot-Fillings Baseline (WorkPlanning PlanItem)](/generated/patterns/A.15.3)
