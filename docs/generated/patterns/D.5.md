...
description: "Part D - Multi-scale Ethics & Conflict-Optimisation"
---
...
- `D.5` --outline_child--> [Taxonomy-Guided Audit Templates](/generated/patterns/D.5.1)
- `D.5` --outline_child--> [Assurance Metrics Roll-up](/generated/patterns/D.5.2)
- `D.5` --explicit_reference--> [Trust-Aware Mediation Calculus](/generated/patterns/D.4)
- `D.5` --explicit_reference--> [Evidence Decay & Epistemic Debt](/generated/patterns/B.3.4)
