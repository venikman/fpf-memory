---
title: "Connect MCP"
description: "Bridge from the FPF reference site to the MCP setup surface."
outline: false
---

# Connect MCP

MCP setup lives on the MCP origin:

[https://mcp.fpf.sh/](https://mcp.fpf.sh/)

This page remains as a compatibility bridge from older `fpf.sh/connect-mcp` links. Keep FPF and MCP separate:

- **FPF** is the specification and reference surface.
