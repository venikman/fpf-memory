...
function renderGithubOutput(report: SyncMonitorReport): string {
  return [
    ...
    ['freshness_basis', report.evidence.basis],
    ['unpublished_commits', String(report.evidence.unpublishedCommits ?? '')],
    ['evidence_url', report.evidence.compareUrl ?? report.evidence.publishedCommitUrl],
