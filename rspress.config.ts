...
function applyAll(){fixTables();fixMobileSearch();fixSidebarGroups();fixSidebarInert();fixHomeFeatureCards();fixNavDropdowns();injectSkipLink();injectHeaderProvenance();}
